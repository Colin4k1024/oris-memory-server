...
pub fn genestore_gene_to_bundle(
    gene: &oris_memory_store::Gene,
) -> Result<ExperienceBundleV1, String> {
...
pub fn attach_genestore_capsule(
    ...
    capsule: &oris_memory_store::Capsule,
) -> Result<(), String> {
...
mod tests {
    ...
    fn legacy_success_count_is_not_promoted_as_verified_evidence() {
        let gene = oris_memory_store::Gene {
            id: uuid::Uuid::new_v4(),
            name: "legacy".into(),
